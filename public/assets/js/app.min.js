...
function (a) {
    ...
    t.prototype.init = function () {
        ...
        a("input[type=checkbox][name=compact]").change(function () {
            switch (a(this).val()) {
                case "fixed": a.App.deactivateCondensedSidebar(),
...
function (a) {
    ...
    t.prototype._applyConfig = function () {
        ...
        switch (this._config = this._getStoredConfig(), a.LeftSidebar.init(), t._config.sideBarTheme) {
            case i: t.activateDarkSidebarTheme();
                break;
...
function (c) {
    "use strict";
    function t() {}t.prototype.send = function (t, e, a, o, i, n, r, s) {
        var d = {
            heading: t,
            text: e,
            position: a,
